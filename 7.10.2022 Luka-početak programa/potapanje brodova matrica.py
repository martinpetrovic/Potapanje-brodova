...
def PROVJERA_I_ZAPIS(x,y,duljinabroda,rotacija):
    ...
    global postavljanje
    if nulmatrica[i][j]== 1:
        print("tu se već nalazi brod")#na ekranu ispisati
        postavljanje = False
    else:
        if rotacija == False:
            if i + duljinabroda > 10:
                print("brod ne stane u polje")
                postavljanje = False                   
            else:
                for k in range(duljinabroda):
                    if nulmatrica[i+k][j] == 1:
                        print("tu se već nalazi brod")
                        postavljanje = False
                        break
                    else:
                        nulmatrica[i+k][j] = 1
                        if duljina_broda == 2:
                            lista_imena_kvadrata[j*10+i+k][0]= "p" 
                        if duljina_broda == 4:
                            lista_imena_kvadrata[j*10+i+k][0]= "b"
                        if duljina_broda == 5:
                            lista_imena_kvadrata[j*10+i+k][0]= "c" 
                        if lista_imena_kvadrata.count("d")>=3:
                            if duljinabroda == 3:
                                lista_imena_kvadrata[j*10+i+k][0]= "s"
                        else:
                            if duljinabroda == 3:
                                lista_imena_kvadrata[j*10+i+k][0]= "d"
        if rotacija == True:
            if j + duljinabroda > 10:
                ...
                for k in range(duljinabroda):
                    if nulmatrica[i+k][j] == 1:
                        ...
                        nulmatrica[i][j+k] = 1
                        if duljinabroda == 2:
                                lista_imena_kvadrata[(j+k)*10+i][0]= "p" 
                        if duljinabroda == 4:
                            lista_imena_kvadrata[(j+k)*10+i][0]= "b"
                        if duljinabroda == 5:
                            lista_imena_kvadrata[(j+k)*10+i][0]= "c"
                        if lista_imena_kvadrata.count("d")>=3:
                            if duljinabroda == 3:
                                lista_imena_kvadrata[(j+k)*10+i][0]= "s"
                        else:
                            if duljinabroda == 3:
                                lista_imena_kvadrata[(j+k)*10+i][0]= "d"
    #print (nulmatrica)
