...
#Za tri broda
tri_broda_kraj_A_p = True
tri_broda_kraj_A_s = True
tri_broda_kraj_A_d = True
tri_broda_kraj_A_b = True
tri_broda_kraj_A_c = True
tri_broda_kraj_B_p = True
tri_broda_kraj_B_s = True
tri_broda_kraj_B_d = True
tri_broda_kraj_B_b = True
tri_broda_kraj_B_c = True

#tri_broda_kraj_A_p,tri_broda_kraj_A_s,tri_broda_kraj_A_d,tri_broda_kraj_A_b,tri_broda_kraj_A_c = True,True,True,True,True
#tri_broda_kraj_B_p,tri_broda_kraj_B_s,tri_broda_kraj_B_d,tri_broda_kraj_B_b,tri_broda_kraj_B_c = True,True,True,True,True
...
def play():
    ...
    global tri_broda_kraj_A
    global tri_broda_kraj_B
    ...
    while pp_run == True:
        ...
        run = True
        while run == True:
            print(tri_broda_kraj_A,tri_broda_kraj_B)
            #pauza_prije_promjene_igraca()
            resetiranje_prije_igre()
            igranje_A_ekran()
            if zmaj == True:
            ...
            #    run = False
            #    break
            if tri_broda_kraj_A == 3 or tri_broda_kraj_B == 3:
                run = False
                break    
            #pauza_prije_promjene_igraca()
            resetiranje_prije_igre()
        ...
        restart = False
        while restart == False:
            end_screen(tri_broda_kraj_A, tri_broda_kraj_B) ##--> umjesto argumenata rezultata_a i b
            if zmaj == True:
                pp_run = False
                restart = True
                break
...
def crtanje_xeva(igrac):  # Funkcija provjerava jesu li pogodeni suparnicki brodovi i crta x-eve ako jesu, crta jedan veliki x ako je cijeli brod unisten
    global tri_broda_kraj_A, tri_broda_kraj_B, tri_broda_kraj_A_p,tri_broda_kraj_A_s,tri_broda_kraj_A_d,tri_broda_kraj_A_b,tri_broda_kraj_A_c,tri_broda_kraj_B_p,tri_broda_kraj_B_s,tri_broda_kraj_B_d,tri_broda_kraj_B_b,tri_broda_kraj_B_c
    if igrac == 'A':
        if patrolB_counter == 2:
            VELIKI_XEVI_LISTA_B[4].draw(PROZOR)
            if tri_broda_kraj_A_p == True:
                tri_broda_kraj_A += 1
                tri_broda_kraj_A_p = False
            print(tri_broda_kraj_A)
        else:
            for i in range(0,100):
        ...
        if submarineB_counter == 3:
            ...
            if tri_broda_kraj_A_s == True:
                tri_broda_kraj_A += 1
                tri_broda_kraj_A_s = False
        else:
            for i in range(0,100):
                recB = lista_rect_kvadrata_B[i]
                if len(lista_imena_kvadrata_B[i]) == 3:
        ...
        if destroyerB_counter == 3:
            ...
            if tri_broda_kraj_A_d == True:
                tri_broda_kraj_A += 1
                tri_broda_kraj_A_d = False
        else:
            for i in range(0,100):
                recB = lista_rect_kvadrata_B[i]
                if len(lista_imena_kvadrata_B[i]) == 3:
        ...
        if battleshipB_counter == 4:
            ...
            if tri_broda_kraj_A_b == True:
                tri_broda_kraj_A += 1
                tri_broda_kraj_A_b = False
        else:
            for i in range(0,100):
                recB = lista_rect_kvadrata_B[i]
                if len(lista_imena_kvadrata_B[i]) == 3:
        ...
        if carrierB_counter == 5:
            ...
            if tri_broda_kraj_A_c == True:
                tri_broda_kraj_A += 1
                tri_broda_kraj_A_c = False
        else:
            for i in range(0,100):
                recB = lista_rect_kvadrata_B[i]
                if len(lista_imena_kvadrata_B[i]) == 3:
        ...
        if patrolA_counter == 2:
            ...
            if tri_broda_kraj_B_p == True:
                tri_broda_kraj_B += 1
                tri_broda_kraj_B_p = False
            print(tri_broda_kraj_B)
        else:
            for i in range(0,100):
        ...
        if submarineA_counter == 3:
            ...
            if tri_broda_kraj_B_s == True:
                tri_broda_kraj_B += 1
                tri_broda_kraj_B_s = False
        else:
            for i in range(0,100):
                recA = lista_rect_kvadrata_A[i]
                if len(lista_imena_kvadrata_A[i]) == 3:
        ...
        if destroyerA_counter == 3:
            ...
            if tri_broda_kraj_B_d == True:
                tri_broda_kraj_B += 1
                tri_broda_kraj_B_d = False
        else:
            for i in range(0,100):
                recA = lista_rect_kvadrata_A[i]
                if len(lista_imena_kvadrata_A[i]) == 3:
        ...
        if battleshipA_counter == 4:
            ...
            if tri_broda_kraj_B_b == True:
                tri_broda_kraj_B += 1
                tri_broda_kraj_B_b = False
        else:
            for i in range(0,100):
                recA = lista_rect_kvadrata_A[i]
                if len(lista_imena_kvadrata_A[i]) == 3:
        ...
        if carrierA_counter == 5:
            ...
            if tri_broda_kraj_B_c == True:
                tri_broda_kraj_B += 1
                tri_broda_kraj_B_c = False
        else:
            for i in range(0,100):
                recA = lista_rect_kvadrata_A[i]
                if len(lista_imena_kvadrata_A[i]) == 3:
        ...
        if event.type == KEYDOWN:
                if event.key == K_ESCAPE:
                    ...
                    if zmaj == True:
                        ...
                        return
    pobjednik = ""
    if rezultat1 == 3: #--> mijenjam u iz 0 u 3, jer ce igra zavrsit nakon 3 broda
        pobjednik = selektirani_profili[1]
    if rezultat2 == 3: #--> mijenjam u iz 0 u 3, jer ce igra zavrsit nakon 3 broda
